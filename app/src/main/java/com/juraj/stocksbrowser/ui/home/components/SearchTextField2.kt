...
@Composable
fun SearchTextField2_PreviewEmpty() {
    StocksBrowserTheme {
        SearchTextField2(TextFieldValue(""), FocusRequester(), {}) { }
    }
}

@Preview(showBackground = true, widthDp = 400)
@Composable
fun SearchTextField2_PreviewWithText() {
    StocksBrowserTheme {
        SearchTextField2(TextFieldValue("Microsoft"), FocusRequester(), {}) { }
    }
}

@Preview(showBackground = true, widthDp = 400)
@Composable
fun SearchTextField2_PreviewWithVeryLongText() {
    StocksBrowserTheme {
        SearchTextField2(
