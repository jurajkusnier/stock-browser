...
@Composable
fun InstrumentListItem3(
    @PreviewParameter(FakeInstrumentItems3::class) instrumentItem: ListItem.InstrumentItem,
...
private class FakeInstrumentItems3 : PreviewParameterProvider<ListItem> {
